...
const FEATURES = {
  ...
  [LICENSE_TIERS.PRO]: {
    ...
    roadmap: [
      ...
      'Multi-language package monitoring (Python, Rust, Go, more)',
      'Advanced security audit workflows with custom schedules',
      'Breaking change detection reports before merging updates',
    ],
  },
  [LICENSE_TIERS.ENTERPRISE]: {
    ...
    roadmap: [
      ...
      'Dedicated support response targets with shared runbooks',
    ],
  },
}
