...
const FEATURES = {
  [LICENSE_TIERS.FREE]: {
    ...
    smartTestStrategy: false, // ✅ Basic pre-push (runs all tests)
    typescriptProtection: true, // ✅ Moved to FREE: tests/tsconfig.json generation
    baselineSecurity: true, // ✅ Moved to FREE: Gitleaks + ESLint security rules
    projectTypeDetection: false, // Limited to basic JS/TS detection
    customSchedules: false,
    advancedWorkflows: false,
    notifications: false,
    multiRepo: false,
    roadmap: [
      '✅ ESLint, Prettier, Stylelint, Husky pre-commit hooks',
      '✅ TypeScript production protection (tests/tsconfig.json)',
      '✅ Baseline security configuration (Gitleaks + ESLint security)',
      '✅ Basic npm dependency monitoring with Dependabot',
    ],
  },
  [LICENSE_TIERS.STARTER]: {
    dependencyMonitoring: 'basic',
    languages: ['npm', 'python'], // ✅ Multi-language support
    frameworkGrouping: false,
    smartTestStrategy: false,
    typescriptProtection: true,
    baselineSecurity: true,
    projectTypeDetection: true, // ✅ Full project-type detection (6 types)
    customSchedules: false,
    advancedWorkflows: false,
    notifications: false,
    multiRepo: false,
    roadmap: [
      ...
      '✅ Advanced project-type detection (CLI, Web, SaaS, API, Library, Docs)',
      '✅ Enhanced troubleshooting guides and documentation',
      '✅ Higher-frequency dependency checks',
      'Email support (48-72h response)',
    ],
  },
  [LICENSE_TIERS.PRO]: {
    dependencyMonitoring: 'premium', // ✅ PREMIUM-001 IMPLEMENTED
    languages: ['npm', 'python'], // ✅ Multi-language included in PRO
    frameworkGrouping: true, // ✅ PREMIUM-001: React, Vue, Angular, Svelte grouping
    smartTestStrategy: true, // ✅ PREMIUM-002 IMPLEMENTED: Adaptive risk-based validation
    typescriptProtection: true,
    baselineSecurity: true,
    projectTypeDetection: true,
    advancedSecurity: true, // ✅ Advanced security hardening
    performanceBudgets: false, // Coming in future
    customSchedules: false,
    advancedWorkflows: false,
    notifications: false,
    multiRepo: false,
    roadmap: [
      ...
      '✅ Smart Test Strategy (adaptive risk-based validation) - KEY DIFFERENTIATOR',
      '✅ Framework-aware dependency grouping (React, Next.js, Vue, Angular)',
      '✅ Premium dependency monitoring with vulnerability scanning',
      '✅ Advanced security hardening (rate limits, stricter audits)',
      'Priority support (24-48h response)',
      'Performance budgets and monitoring - Coming Q1 2026',
      'Breaking change detection reports - Coming Q2 2026',
    ],
  },
  [LICENSE_TIERS.ENTERPRISE]: {
    dependencyMonitoring: 'enterprise', // ✅ Portfolio-wide analytics
    languages: ['npm', 'python', 'rust', 'go'], // ✅ All languages
    ...
    notifications: true, // ✅ Slack, Teams integration
    multiRepo: true, // ✅ Portfolio management
    policyEnforcement: true, // ✅ NEW: Cross-repo policy enforcement
    ssoIntegration: false, // Coming Q1 2026
    auditTrails: false, // Coming Q1 2026
    customTemplates: true, // ✅ NEW: Custom organization templates
    roadmap: [
      ...
      'Comprehensive audit trails - Coming Q1 2026',
      'Custom notification channels (Slack, Teams) - Coming Q2 2026',
    ],
  },
}
...
function isDeveloperMode() {
  ...
  if (process.env.CQA_DEVELOPER === 'true') {
    return true
  }
...
function showUpgradeMessage(feature) {
  ...
  if (license.tier === LICENSE_TIERS.FREE) {
    ...
    console.log('   • Basic dependency grouping')
    ...
    console.log('   • Priority email support')
    console.log('\n💰 Pricing: Pro $49/month')
    console.log('   • Limited-time founder pricing: $24.50/month')
    console.log('\n🌟 Upgrade: https://www.aibuilderlab.com/cqa-upgrade')
    ...
    console.log('\n💰 Pricing: $149/month')
    console.log('   • Limited-time founder pricing: $74.50/month')
