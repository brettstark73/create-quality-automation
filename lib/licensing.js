...
function showLicenseStatus() {
  ...
  // Show caps for FREE tier
  if (license.tier === LICENSE_TIERS.FREE) {
    console.log(`   Private Repos: 1 max`)
    console.log(`   Lines of Code: 2,000 max`)
    console.log(`   Dependency PRs: 10/month`)
    console.log(`   Pre-push Runs: 50/month`)
  } else {
