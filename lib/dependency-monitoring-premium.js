...
/**
 * Parse pyproject.toml for Python dependencies (simple regex-based)
 */
function parsePyprojectToml(pyprojectPath) {
  ...
  // Allow hyphens, dots, underscores in package names (e.g., scikit-learn, pytest-cov, django-cors-headers)
