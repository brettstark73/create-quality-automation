 ...
 * @param {boolean} [isPro] - Whether Pro tier is enabled (currently unused, for future extensibility)
 */
function getPrelaunchDependencies(isPro) {
  void isPro // Reserved for future Pro-tier dependencies
  return {
    linkinator: '^6.0.0',
    'pa11y-ci': '^3.1.0',
  }
