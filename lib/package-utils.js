 ...
 */
function mergeLintStaged(existing = {}, defaults, options = {}, patternChecker = null) {
  ...
  const hasExistingCssPatterns = patternChecker &&
    Object.keys(existing).some(patternChecker)
