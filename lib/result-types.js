...
function success(data = null) {
  ...
  const result = { success: /** @type {true} */ (true) }
...
function failure(error, details = null) {
  /** @type {{ success: false, error: string, details?: any }} */
  const result = { success: /** @type {false} */ (false), error }
...
function valid(data = null) {
  /** @type {{ valid: true, data?: any }} */
  const result = { valid: /** @type {true} */ (true) }
  if (data !== null && data !== undefined) {
    result.data = data
  }
  return result
...
function invalid(error, details = null) {
  /** @type {{ valid: false, error: string, details?: any }} */
  const result = { valid: /** @type {false} */ (false), error }
  if (details !== null && details !== undefined) {
    result.details = details
  }
  return result
